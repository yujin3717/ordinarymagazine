...
export default {
    data(){
        return{
            ...
            poster: 'https://d2bdkorgfosgj9.cloudfront.net/ordinary/vol.27/video/video-poster.jpg',
            videosrc: 'https://d2bdkorgfosgj9.cloudfront.net/ordinary/vol.27/video/video.mp4',
            videotitle: '',
