	...
	export default {
		data(){
			return {
				pagenum: 'page-1',
				databrandNm: 'Opening',
				background: 'http://d2bdkorgfosgj9.cloudfront.net/ordinary/vol.27/images/pages/p01/bg-left.jpg',
				backgroundP: 'right bottom',
				background2: 'http://d2bdkorgfosgj9.cloudfront.net/ordinary/vol.27/images/pages/p01/bg-right.jpg',
