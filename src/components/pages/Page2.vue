	...
	export default {
		data(){
			return {
				pagenum: 'page-2',
				databrandNm: '',
				background: 'http://ordinary.dev.tebah.media/vol.27/images/pages/p02/bg-left.jpg',
				...
				description: `<div class="kor">“ 라디오는 생각을 위한 극장이고, 텔레비전은 생각 없는 이들을 위한 극장이다.</div>
									...
									<div class="author">- Steve Allen</div>`,
				txt: 'ON AIR',
			}
		}
	}
